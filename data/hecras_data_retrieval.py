...
def get_cell_area(filepath: str, perimeter_name: str = 'Perimeter 1') -> np.ndarray:
    property_path = f'Geometry.2D Flow Areas.{perimeter_name}.Cells Surface Area'
    return file_utils.read_hdf_file_as_numpy(filepath=filepath, property_path=property_path)

def get_roughness(filepath: str, perimeter_name: str = 'Perimeter 1') -> np.ndarray:
    property_path = f"Geometry.2D Flow Areas.{perimeter_name}.Cells Center Manning's n"
    return file_utils.read_hdf_file_as_numpy(filepath=filepath, property_path=property_path)

def get_rainfall(filepath: str, perimeter_name: str = 'Perimeter 1') -> np.ndarray:
...
def get_water_level(filepath: str, perimeter_name: str = 'Perimeter 1') -> np.ndarray:
...
def get_edge_direction_x(filepath: str, perimeter_name: str = 'Perimeter 1') -> np.ndarray:
...
def get_edge_direction_y(filepath: str, perimeter_name: str = 'Perimeter 1') -> np.ndarray:
    property_path = f'Geometry.2D Flow Areas.{perimeter_name}.Faces NormalUnitVector and Length'
    data = file_utils.read_hdf_file_as_numpy(filepath=filepath, property_path=property_path)
...
def get_face_length(filepath: str, perimeter_name: str = 'Perimeter 1') -> np.ndarray:
    property_path = f'Geometry.2D Flow Areas.{perimeter_name}.Faces NormalUnitVector and Length'
    data = file_utils.read_hdf_file_as_numpy(filepath=filepath, property_path=property_path)
...
def get_velocity(filepath: str, perimeter_name: str = 'Perimeter 1') -> np.ndarray:
