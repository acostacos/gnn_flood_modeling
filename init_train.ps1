python train.py --model 'GCN' --config_path='configs/config.yaml' --log_path 'logs/init/init_gcn.log' --seed 42 --model_dir 'saved_models/init/gcn'
python train.py --model 'GAT' --config_path='configs/config.yaml' --log_path 'logs/init/init_gat.log' --seed 42 --model_dir 'saved_models/init/gat'
python train.py --model 'GIN' --config_path='configs/config.yaml' --log_path 'logs/init/init_gin.log' --seed 42 --model_dir 'saved_models/init/gin'
