...
def main():
    ...
    try:
        ...
        output_dir_path = dataset_parameters['output_dir_path']

        hec_ras_hdf_paths = dataset_parameters['hec_ras_hdf_paths']
        nodes_shp_path = dataset_parameters['nodes_shp_path']
        edges_shp_path = dataset_parameters['edges_shp_path']
